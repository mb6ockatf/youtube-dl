...
class CallinIE(InfoExtractor):
    ...
    def _search_nextjs_data(
        self, webpage, video_id, transform_source=None, fatal=True, **kw
    ):
    ...
    def _real_extract(self, url):
        ...
        episode = traverse_obj(
            next_data, ("props", "pageProps", "episode"), expected_type=dict
        )
        if not episode:
        ...
        channel_url = try_get(
            episode, lambda x: x["show"]["linkObj"]["resourceUrl"], compat_str
        )
