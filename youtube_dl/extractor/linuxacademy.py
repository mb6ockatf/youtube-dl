...
class LinuxAcademyIE(InfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        item_id = (
            course_id if course_id else "%s-%s" % (chapter_id, lecture_id)
        )
        ...
        if course_id:
            ...
            for item in module["items"]:
                ...
                def type_field(key):
                    return (
                        try_get(item, lambda x: x["type"][key], compat_str)
                        or ""
                    ).lower()
                ...
                if "section" in type_fields:
                    ...
                    chapter_number = (
                        1 if not chapter_number else chapter_number + 1
                    )
                    continue
                # Skip non-lessons
            ...
            return {
                ...
                "description": module.get("md_desc")
                or clean_html(module.get("desc")),
