    ...
    def _real_extract(self, url):
        ...
        season_search = self._download_json(
            ...
            query={
                ...
                "attributesToRetrieve": "description,search_%s_episode_number,search_document_date,search_url,title,search_atk_episode_season"
                % slug,
        ...
        def entries():
            for episode in season_search.get("hits") or []:
                ...
                yield {
                    "_type": "url",
                    "url": "https://www.americastestkitchen.com%s%s"
                    % (show_path, search_url),
                    "id": try_get(
                        episode, lambda e: e["objectID"].rsplit("_", 1)[-1]
                    ),
