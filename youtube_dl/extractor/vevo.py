...
class VevoIE(VevoBaseIE):
    ...
    def _call_api(self, path, *args, **kwargs):
        try:
            ...
            if isinstance(e.cause, compat_HTTPError):
                errors = self._parse_json(e.cause.read().decode(), None)[
                    "errors"
                ]
                error_message = ", ".join(
    ...
    def _real_extract(self, url):
            ...
            if ".ism" in version_url:
                ...
                formats.extend(
                    self._extract_mpd_formats(
                        ...
                        errnote="Failed to download %s MPD information"
                        % version,
                        fatal=False,
                    )
                )
        ...
        genre = (
            ...
            and isinstance(genres[0], compat_str)
            else None
        )
