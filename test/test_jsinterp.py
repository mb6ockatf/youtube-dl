...
class TestJSInterpreter(unittest.TestCase):
    ...
    def test_operators(self):
        ...
        self._test(
            "function f(){var x = {a: 1}; var y = x; return x == y}", True
        )
    ...
    def test_indexing(self):
        ...
        self._test('function f() { var o = {1: 2, 3: 4}; return o["3"]}', 4)
        self._test(
            'function f() { return [1, [2, {3: [4]}]][1][1]["3"][0]}', 4
        )
        ...
        self._test(
            'function f() { var o = {1: 2, 3: 4}; o["length"] = 42; return o.length}',
            42,
        )
    ...
    def test_split(self):
        ...
        # RegExp split
        self._test(
            'function f(){return "test".split(/(?:)/)}', ["t", "e", "s", "t"]
        )
        self._test(
            'function f(){return "t-e-s-t".split(/[es-]+/)}', ["t", "t"]
        )
        ...
        if sys.version_info >= (2, 6) and not (
            (3, 0) <= sys.version_info < (3, 3)
        ):
            self._test(
                'function f(){return "😄😄".split(/(?:)/u)}', ["😄", "😄"]
            )
